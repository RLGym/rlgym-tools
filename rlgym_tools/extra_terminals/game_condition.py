...
class GameCondition(TerminalCondition):  # Mimics a Rocket League game
    def __init__(self, tick_skip=8, seconds_left=300, forfeit_spg_limit=None, max_overtime=300, max_no_touch = 60):
        ...
        self.touch_timeout = NoTouchTimeoutCondition((120/tick_skip) * max_no_touch)
    ...
    def is_terminal(self, current_state: GameState) -> bool:
        self.done = self.touch_timeout.is_terminal(current_state)
        if not self.done:
