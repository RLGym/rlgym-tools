...
def main():
    parsed_replay = ParsedReplay.load("test_replays/0328fc07-13fb-4cb6-9a86-7d608196ddbd.replay")
    rewards_list = [
        (EpisodeEnd(), ""),
        ...
        (BallTravelReward(1, 0, 0, 0, 0, 0, do_integral=True), "/integral"),
        (BallTravelReward(1, 0, 0, 0, 0, 0), "/consecutive"),
        (BallTravelReward(0, 1, 0, 0, 0, 0), "/pass"),
        (BallTravelReward(0, 0, 1, 0, 0, 0), "/receive"),
        (BallTravelReward(0, 0, 0, 1, 0, 0), "/giveaway"),
        (BallTravelReward(0, 0, 0, 0, 1, 0), "/intercept"),
        (BallTravelReward(0, 0, 0, 0, 0, 1), "/goal"),
        (GoalViewReward(), ""),
        ...
        (VelocityPlayerToBallReward(True, True), "/trajectory_comparison"),
        (BoostChangeReward(), ""),
        (BoostKeepReward(), ""),
    ...
    fig = generate_plot(meta_df, reward_df)
